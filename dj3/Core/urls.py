...
from . import views
from .views import RegisterView, OtpVerifyView  # Make sure both views are imported
...
urlpatterns = [
    ...
    path('otp-verify/', OtpVerifyView, name='otp_verify'),  # Add the OTP verification URL
